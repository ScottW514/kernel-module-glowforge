...
#define ATTR_LASER_ENABLE_PATH          SYSFS_ATTR_DIR STR(ATTR_LASER_ENABLE)
#define ATTR_LASER_ON_PATH              SYSFS_ATTR_DIR STR(ATTR_LASER_ON)
#define ATTR_LASER_ON_SAMPLED_PATH      SYSFS_ATTR_DIR STR(ATTR_LASER_ON_SAMPLED)
#define ATTR_LASER_PGOOD_PATH           SYSFS_ATTR_DIR STR(ATTR_LASER_PGOOD)
#define ATTR_LASER_PGOOD_SAMPLED_PATH   SYSFS_ATTR_DIR STR(ATTR_LASER_PGOOD_SAMPLED)
#define ATTR_INTERLOCK_CIRCUIT_PATH     SYSFS_ATTR_DIR STR(ATTR_INTERLOCK_CIRCUIT)
#define ATTR_INTERLOCK_LATCH_RESET_PATH SYSFS_ATTR_DIR STR(ATTR_INTERLOCK_LATCH_RESET)
#define ATTR_BUTTON_LATCH_PATH          SYSFS_ATTR_DIR STR(ATTR_BUTTON_LATCH)
#define ATTR_CHARGE_PUMP_ALIVE_PATH     SYSFS_ATTR_DIR STR(ATTR_CHARGE_PUMP_ALIVE)
